...
if (sizeof($topic_list_process)) {
    ...
    foreach ($topic_list_process as $topic_id) {
        ...
        $template->assign_block_vars('topicrow1', $topic_row);

        $pagination->generate_template_pagination($view_topic_url, 'topicrow1.pagination_new', 'news', $replies + 1, $config['posts_per_page'], 1, true, true);
