...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000018b76bea000000003c419b15(
...
class phpbbtemplatetwiglexer_0000000018b76bea000000003c419b15 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590d44eae1578625408792 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590d44eae1578868647386 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590d44eae1578899882693 = array(
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, 'set_environment', array('env' => $env), $this->initializer590d44eae1578868647386);

        return $this->valueHolder590d44eae1578625408792->set_environment($env);
    }
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590d44eae1578868647386);

        return $this->valueHolder590d44eae1578625408792->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590d44eae1578868647386);

        return $this->valueHolder590d44eae1578625408792->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590d44eae1578868647386 = $initializer;
    }
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__get', array('name' => $name), $this->initializer590d44eae1578868647386);

        if (isset(self::$publicProperties590d44eae1578899882693[$name])) {
            return $this->valueHolder590d44eae1578625408792->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590d44eae1578625408792;
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590d44eae1578868647386);
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__isset', array('name' => $name), $this->initializer590d44eae1578868647386);
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__unset', array('name' => $name), $this->initializer590d44eae1578868647386);
    ...
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__clone', array(), $this->initializer590d44eae1578868647386);

        $this->valueHolder590d44eae1578625408792 = clone $this->valueHolder590d44eae1578625408792;
    }

    public function __sleep()
    {
        $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, '__sleep', array(), $this->initializer590d44eae1578868647386);

        return array('valueHolder590d44eae1578625408792');
    }
    ...
    {
        return $this->initializer590d44eae1578868647386;
    }
    ...
    {
        return $this->initializer590d44eae1578868647386 && $this->initializer590d44eae1578868647386->__invoke($this->valueHolder590d44eae1578625408792, $this, 'initializeProxy', array(), $this->initializer590d44eae1578868647386);
    }
    ...
    {
        return null !== $this->valueHolder590d44eae1578625408792;
    }
    ...
    {
        return $this->valueHolder590d44eae1578625408792;
    }
