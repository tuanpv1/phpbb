...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003af195530000000053e5f236(
...
class phpbbtemplatetwiglexer_000000003af195530000000053e5f236 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590d46171f7e8891692490 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590d46171f7e8264660468 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590d46171f7e8185024319 = array(
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, 'set_environment', array('env' => $env), $this->initializer590d46171f7e8264660468);

        return $this->valueHolder590d46171f7e8891692490->set_environment($env);
    }
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590d46171f7e8264660468);

        return $this->valueHolder590d46171f7e8891692490->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590d46171f7e8264660468);

        return $this->valueHolder590d46171f7e8891692490->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590d46171f7e8264660468 = $initializer;
    }
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__get', array('name' => $name), $this->initializer590d46171f7e8264660468);

        if (isset(self::$publicProperties590d46171f7e8185024319[$name])) {
            return $this->valueHolder590d46171f7e8891692490->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590d46171f7e8891692490;
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590d46171f7e8264660468);
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__isset', array('name' => $name), $this->initializer590d46171f7e8264660468);
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__unset', array('name' => $name), $this->initializer590d46171f7e8264660468);
    ...
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__clone', array(), $this->initializer590d46171f7e8264660468);

        $this->valueHolder590d46171f7e8891692490 = clone $this->valueHolder590d46171f7e8891692490;
    }

    public function __sleep()
    {
        $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, '__sleep', array(), $this->initializer590d46171f7e8264660468);

        return array('valueHolder590d46171f7e8891692490');
    }
    ...
    {
        return $this->initializer590d46171f7e8264660468;
    }
    ...
    {
        return $this->initializer590d46171f7e8264660468 && $this->initializer590d46171f7e8264660468->__invoke($this->valueHolder590d46171f7e8891692490, $this, 'initializeProxy', array(), $this->initializer590d46171f7e8264660468);
    }
    ...
    {
        return null !== $this->valueHolder590d46171f7e8891692490;
    }
    ...
    {
        return $this->valueHolder590d46171f7e8891692490;
    }
