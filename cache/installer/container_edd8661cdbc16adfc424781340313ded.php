...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002cdd43b90000000074cd446e(
...
class phpbbtemplatetwiglexer_000000002cdd43b90000000074cd446e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590d44dedbba0957938897 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590d44dedbba0551902210 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590d44dedbba0550285987 = array(
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, 'set_environment', array('env' => $env), $this->initializer590d44dedbba0551902210);

        return $this->valueHolder590d44dedbba0957938897->set_environment($env);
    }
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590d44dedbba0551902210);

        return $this->valueHolder590d44dedbba0957938897->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590d44dedbba0551902210);

        return $this->valueHolder590d44dedbba0957938897->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590d44dedbba0551902210 = $initializer;
    }
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__get', array('name' => $name), $this->initializer590d44dedbba0551902210);

        if (isset(self::$publicProperties590d44dedbba0550285987[$name])) {
            return $this->valueHolder590d44dedbba0957938897->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590d44dedbba0957938897;
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590d44dedbba0551902210);
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__isset', array('name' => $name), $this->initializer590d44dedbba0551902210);
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__unset', array('name' => $name), $this->initializer590d44dedbba0551902210);
    ...
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__clone', array(), $this->initializer590d44dedbba0551902210);

        $this->valueHolder590d44dedbba0957938897 = clone $this->valueHolder590d44dedbba0957938897;
    }

    public function __sleep()
    {
        $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, '__sleep', array(), $this->initializer590d44dedbba0551902210);

        return array('valueHolder590d44dedbba0957938897');
    }
    ...
    {
        return $this->initializer590d44dedbba0551902210;
    }
    ...
    {
        return $this->initializer590d44dedbba0551902210 && $this->initializer590d44dedbba0551902210->__invoke($this->valueHolder590d44dedbba0957938897, $this, 'initializeProxy', array(), $this->initializer590d44dedbba0551902210);
    }
    ...
    {
        return null !== $this->valueHolder590d44dedbba0957938897;
    }
    ...
    {
        return $this->valueHolder590d44dedbba0957938897;
    }
