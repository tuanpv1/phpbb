...
$lang = array_merge($lang, array(
    ...
    'AVATAR_SELECT' => 'Chọn ảnh đại diện',
    'AVATAR_TYPE' => 'Kiểu anh đại diện',
    'AVATAR_DRIVER_UPLOAD_EXPLAIN' => 'Tải hình đại diện của bạn',
    ...
    'PASS_TYPE_ANY_EXPLAIN' => 'Mật khẩu của bạn phải nhiều hơn <strong>%1$d</strong> ký tự, không được vượt quá <strong>%2$d</strong> ký tự',
    ...
    'UPLOAD_AVATAR_FILE' => 'Chọn hình ảnh',
    'AVATAR_DRIVER_LOCAL_TITLE' => 'Chọn từ thư viên của bạn',
    'NO_AVATARS' => 'Hiện thư viện không có ảnh nào',
    'AVATAR_DRIVER_LOCAL_EXPLAIN' => 'Thư viện ảnh',
    'AVATAR_DRIVER_UPLOAD_TITLE' => 'Tải ảnh từ máy tính',
    'PROFILE_AUTOLOGIN_KEYS' => 'Tải ảnh từ máy tính',
    'UCP_PROFILE_AUTOLOGIN_KEYS' => 'Quản lý key tự động đăng nhập',
    'LOGIN_KEY' => 'Key đăng nhập',
    'LOGIN_TIME' => 'Thời gian đăng nhập',
    'UCP_NOTIFICATION_OPTIONS' => 'Quản lý thông báo',
